...
public class MusicManager : SerializedMonoBehaviour
{
    ...
    [SerializeField] private AudioClip successLayerSound;
    ...
    {
#if UNITY_EDITOR
        musicSource.volume = GameController.Instance.useProfile.OnMusic ? 0f : 0;
#else
        musicSource.volume = GameController.Instance.useProfile.OnMusic ? 0.4f : 0;
#endif
...
#region === Play Sound ===
    ...
    {
        PlaySingle(clickSound, SourceAudio.Effect);
    }

    public void PlaySuccessLayerSound()
    {
        PlaySingle(successLayerSound, SourceAudio.Effect);
    }
